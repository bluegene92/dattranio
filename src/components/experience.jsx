...
const Experience = () => {
    ...
    return (
        <div>
            ...
            <h2 className="text-emerald-400">Full-Stack Developer - Freelance</h2>
            ...
            <h2 className="text-emerald-400">.Net Developer</h2>
            <p>
            ...
            <h2 className="text-emerald-400">Dell Technical Analyst</h2>
